...
export const NAV_DATA: NavData[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://www.brcline.com/wp-content/uploads/2016/01/bootstrap-logo.png',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://adminlte.io/wp-content/uploads/2022/02/tailwindcss-templates.png',
  ...
  },
  {
    ...
    items: [
      {
        icon: {
          svg: '<svg viewBox="0 0 780 250"><path fill="#231F20" d="M240,250h100v-50h100V0H240V250z M340,50h50v100h-50V50z M480,0v200h100V50h50v150h50V50h50v150h50V0H480z M0,200h100V50h50v150h50V0H0V200z"></path></svg>',
        },
        title: 'npm',
        desc: 'npm是Node.js默认的、用JavaScript编写的软件包管理系统。',
        link: 'https://www.npmjs.com',
      },
      {
        icon: 'https://seeklogo.com/images/Y/yarn-logo-F5E7A65FA2-seeklogo.com.png',
        title: 'Yarn',
        desc: 'Yarn 是一个快速、可靠、安全的依赖管理工具',
        link: 'https://yarnpkg.com',
      },
      {
        icon: 'https://pnpm.io/zh/img/pnpm-no-name-with-frame.svg',
        title: 'pnpm',
        desc: '快速、零硬盘空间使用、并行安装的 npm 替代工具',
        link: 'https://pnpm.io',
      },
      {
        icon: 'https://seeklogo.com/images/B/bun-logo-A876328A1F-seeklogo.com.png',
        title: 'bun',
        desc: 'bun包含一个与 Node.js 兼容的包管理器，旨在以更快的速度替代npm、yarn和pnpm',
        link: 'https://bun.sh/',
      },
    ],
  },
